...
from .utils import COUNTRIES, ROLES
...
#     lead = models.ForeignKey('leads.Lead',blank=True, null=True,related_name="leads_comments",on_delete=models.CASCADE)
...
#     user = models.ForeignKey('User', blank=True, null=True,related_name="user_comments",on_delete=models.CASCADE)
#     task = models.ForeignKey('tasks.Task', blank=True, null=True,related_name='tasks_comments', on_delete=models.CASCADE)
#     invoice = models.ForeignKey('invoices.Invoice', blank=True, null=True,related_name='invoice_comments', on_delete=models.CASCADE)
#     event = models.ForeignKey('events.Event', blank=True, null=True,related_name='events_comments', on_delete=models.CASCADE)
#
#     def get_files(self):
...
#     created_by = models.ForeignKey(User, related_name='attachment_created_by',on_delete=models.SET_NULL, null=True)
...
#     task = models.ForeignKey('tasks.Task', blank=True, null=True,related_name='tasks_attachment', on_delete=models.CASCADE)
#     invoice = models.ForeignKey('invoices.Invoice', blank=True, null=True,related_name='invoice_attachment', on_delete=models.CASCADE)
#     event = models.ForeignKey('events.Event', blank=True, null=True,related_name='events_attachment', on_delete=models.CASCADE)
#
#     def file_type(self):
